...
#HTML file creation
filein = open('ProblemTickets.csv', "r")
...
<body>
<h1 align="center"> Problem Tickets </h1>
...
dict = {"name":"Problem Tickets","dashboardId":<dashboardID>, "type":"text", "theme" : "borderBlue", "colSpan":10, "rowSpan":10}
